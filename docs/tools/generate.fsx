...
let githubLink = "http://github.com/bradphelan/majk"

// Specify more information about your project
let info =
  [ "project-name", "majk"
    "project-author", "Brad Phelan"
    "project-summary", "A fast incremental build tool written in fsharp"
    "project-github", githubLink
    "project-nuget", "http://nuget.org/packages/majk" ]
